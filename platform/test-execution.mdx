---
title: "Run tests and record pass/fail results"
description: "Execute test scripts in TestFactors, record pass/fail results in real time, and log defects inline without breaking your testing flow."
icon: "play"
---
