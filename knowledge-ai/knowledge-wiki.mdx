...
description: "Capture institutional knowledge — terminology, decisions, lessons learned — so TestFactors' AI gets smarter with every release."
icon: "library"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Link to source documents" icon="link">
    *"Per <link to SF release note>, the new field X replaces Y in v2H 2025"* — citations turn wiki into knowledge.
  </Card>
</CardGroup>
